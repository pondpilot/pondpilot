  ...
  return (
    ...
    >
      <Group
        ...
        className={`h-full overflow-auto p-14 ${isDragging ? 'blur-sm' : ''}`}
      >
        <Stack w={700} gap={16}>
      ...
      {isDragging && (
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <Stack align="center" className="bg-backgroundAccent-light bg-opacity-20 rounded-xl p-10">
            <Image src={colorScheme === 'dark' ? duckDark : duck} />

            <Title order={4}>Drop files here</Title>
          </Stack>
        </div>
      )}
    </div>
