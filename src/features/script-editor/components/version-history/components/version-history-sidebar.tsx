...
export const VersionHistorySidebar = ({
  ...
  return (
    <div
      ...
      className="w-[280px] shrink-0 h-full flex flex-col border-l border-borderPrimary-light dark:border-borderPrimary-dark bg-backgroundPrimary-light dark:bg-backgroundPrimary-dark outline-hidden"
